...
import random 
import requests 
# Importing firestore client object for type clarity
...
def initialize_firebase():
    ...
    try:
        ...
        # FIX: Capture the app instance when initializing with a name
        app = initialize_app(cred, name=f"screener_app_{APP_ID}")
        print("Firebase Admin SDK initialized successfully.")
        
        # FIX: Explicitly pass the app instance to firestore.client()
